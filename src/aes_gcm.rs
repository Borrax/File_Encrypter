...
pub fn aes_gcm_encrypt(key: &[u8; 32], nonce: &[u8; 12], plain_input: &[u8], aad: &[u8]) -> (Vec<u8>, [u8; 16]) {
...
pub fn aes_gcm_decrypt(key: &[u8; 32], nonce: &[u8; 12],
...
mod unit_tests {
    ...
    #[test]
    fn test_mix_columns_single_column() {
        let input: [u8; 16] = [
            0xdb, 0x13, 0x53, 0x45,
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
